...
{
    public class PartyMemberDataTableEntry : IDataTable
    {
        public PartyMemberDataTableEntry() { }
        ...
        public long m_RandomizeConstantly { get; set; }
        public long BoolProperty { get; set; }
        public List<byte> Unk4 { get; set; } // 8 bytes
        public byte RandomizeConstantly { get; set; }
        ...
        public IDataTable Decompile(FileStream reader)
        {
            ...
            this.m_RandomizeConstantly = BitConverter.ToInt64(reader.ReadBytesFromFileStream(8).ToArray());
            ...
            this.RandomizeConstantly = (byte)reader.ReadByte();
        ...
        public List<byte> Recompile()
        {
            ...
            data.AddRange(BitConverter.GetBytes(this.m_RandomizeConstantly));
            data.AddRange(BitConverter.GetBytes(this.BoolProperty));
            data.AddRange(this.Unk4);
            data.Add(this.RandomizeConstantly);
            data.Add(this.Unk5);
